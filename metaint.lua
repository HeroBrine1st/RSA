...
-- На эту библиотеку (данный файл) распространяется лицензия от Zer0Galaxy, если она существует. Лицензия RSA не распространяется на эту библиотеку (данный файл)
